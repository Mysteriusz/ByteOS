...
#define VIDEO_ELEMENT_TYPE_OFFSET OFFSET_OF(VIDEO_ELEMENT, type)
#define VIDEO_ELEMENT_LPOS_OFFSET OFFSET_OF(VIDEO_ELEMENT, lPos)
#define VIDEO_ELEMENT_RPOS_OFFSET OFFSET_OF(VIDEO_ELEMENT, rPos)
#define VIDEO_ELEMENT_COL_OFFSET OFFSET_OF(VIDEO_ELEMENT, color)
#define VIDEO_ELEMENT_ID_OFFSET OFFSET_OF(VIDEO_ELEMENT, id)
