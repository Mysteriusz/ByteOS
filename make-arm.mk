...
BOOTARMH=$(shell find /mnt/d/byteos \( $(EXCLUDED_PATHS) \) -prune -false -o -type d -print | sed 's/^/-I /')
BOOTARMC=$(shell find /mnt/d/byteos \( $(EXCLUDED_PATHS) \) -prune -false -o -name "*.c" -print)
BOOTARMS=$(shell find /mnt/d/byteos \( $(EXCLUDED_PATHS) \) -prune -false -o -name "*.s" -print)
