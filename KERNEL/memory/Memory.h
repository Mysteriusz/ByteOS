...
typedef struct MEMORY_PAGE_POOL MEMORY_PAGE_POOL;
typedef struct MEMORY_PAGE_POOL_BLOCK MEMORY_PAGE_POOL_BLOCK;
typedef struct MEMORY_PAGE_POOL_BLOCK{
    MEMORY_PAGE_POOL_BLOCK *next;
    UINT16 rva;
    UINT16 size;
} MEMORY_PAGE_POOL_BLOCK;
typedef struct MEMORY_PAGE_POOL{
    MEMORY_PAGE_POOL_BLOCK *blocks;
    UINT32 blockCount;
...
UINT32 PAGE_POOL_INDEX(UINT32 pageIndex);
