...
typedef struct PCI_HBA_AHCI_FIS_H2D{
...
typedef struct PCI_HBA_AHCI_FIS_D2H{
    PCI_FIS_TYPE fisType;
    UINT8 portMultiplier : 4;
    UINT8 reserved0 : 2;
    UINT8 interrupt : 1;
...
typedef struct PCI_HBA_AHCI_FIS_DATA{
    PCI_FIS_TYPE fisType;
    UINT8 portMultiplier : 4;
    UINT8 reserved0 : 4;
    UINT8 reserved1[2];
...
typedef struct PCI_HBA_AHCI_FIS_PIO{
    PCI_FIS_TYPE fisType;
    UINT8 portMultiplier : 4;
    UINT8 reserved0 : 1;
...
typedef struct PCI_HBA_AHCI_FIS_DMA{
    PCI_FIS_TYPE fisType;
    UINT8 portMultiplier : 4;
    UINT8 reserved0 : 1;
    UINT8 dataDirection : 1;
...
typedef struct PCI_HBA_AHCI_COMMAND_SESSION{
